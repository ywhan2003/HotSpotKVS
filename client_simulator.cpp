...
ClientSimulator::ClientSimulator(KeyValueStore& kv_store, int key_length, int value_length, double hotspot_ratio, size_t total_keys, size_t hotspot_keys)
    : kv_store_(kv_store), key_length_(key_length), value_length_(value_length), hotspot_ratio_(hotspot_ratio) {
